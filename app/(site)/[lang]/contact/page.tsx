...
export default async function ContactPage(
  ...
  const organizationSchema = generateOrganizationSchema({ title: 'HousePlus', description: t.meta, url: `https://www.houseplus-ch.com/${lang}/${contactPath}/`, lang, type: 'Organization' });
  const breadcrumbSchema = generateBreadcrumbSchema([{ name: 'Home', url: `https://www.houseplus-ch.com/${lang}/` }, { name: t.title, url: `https://www.houseplus-ch.com/${lang}/${contactPath}/` }]);
