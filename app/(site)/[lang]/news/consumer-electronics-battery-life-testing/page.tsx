...
const articleContent: Record<string, any> = {
  en: {
    ...
    heroImage: 'https://images.houseplus-ch.com/media/houseplus-articles-covers-consumer-electronics-battery-life-testing-b2b-guide/',
...
export default async function BlogPostPage(props: { params: Promise<{ lang: string }> }) {
  ...
  const imageObjectSchema = generateImageObjectSchema({
    ...
    description: 'Battery cycle life testing equipment performing 1C charge-discharge cycles at 25°C standard conditions for consumer electronics',
    width: 1200,
    height: 675,
  });
      ...
      <section className="max-w-4xl mx-auto px-4 pb-16">
        <div className="bg-gradient-to-br from-amber-500 to-orange-700 rounded-3xl p-8 md:p-12 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href={localizedHref(lang, '/products')} className="inline-flex items-center justify-center px-8 py-4 bg-white text-orange-700 font-bold rounded-full hover:bg-orange-50 transition-colors">
