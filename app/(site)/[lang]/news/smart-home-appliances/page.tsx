...
export default async function SmartHomeAppliancesArticle(props: { params: Promise<{ lang: string }> }) {
  const params = await props.params;
  const { lang } = params;
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          image: 'https://images.houseplus-ch.com/media/houseplus-electric-kettle-1-5l-wholesale/',
  ...
  const articleSchema = generateArticleSchema({
    url: `https://www.houseplus-ch.com/${lang}/news/smart-home-appliances`,
    headline: data.title,
    ...
    description: generateSEOMetadata({ lang: toLocale(lang), type: 'article', title: data.title, description: data.sections[0].text, keywords: [], url: `/${lang}/news/smart-home-appliances` }).description as string,
  });
