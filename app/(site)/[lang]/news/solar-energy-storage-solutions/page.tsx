...
export default async function SolarEnergyStorageArticle(props: { params: Promise<{ lang: string }> }) {
  const params = await props.params;
  const { lang } = params;
      ...
      sections: [
        {
          ...
          image: 'https://images.houseplus-ch.com/media/houseplus-articles-solar-solar-energy-storage-battery-bank-b2b-guide/',
        ...
        },
        {
          ...
          image: 'https://images.houseplus-ch.com/media/houseplus-pure-sine-inverter-2000w-wholesale/',
  ...
  const articleSchema = generateArticleSchema({
    ...
    description: generateSEOMetadata({ lang: toLocale(lang), type: 'article', title: data.title, description: data.sections[0].text, keywords: [], url: `/${lang}/news/solar-energy-storage-solutions` }).description as string,
  });
