...
export default async function RegionsPage(props: { params: Promise<{ lang: string }> }) {
  ...
  return <SchemaRenderer schemas={schemas}><main className="min-h-screen bg-white">
    ...
    <section className="py-8 px-4 md:px-8"><div className="max-w-6xl mx-auto"><div className="relative h-80 rounded-2xl overflow-hidden shadow-xl"><Image src="https://images.houseplus-ch.com/media/houseplus-site-global-world-map-markets/" alt={t.image.alt} title={t.image.title} fill sizes="(max-width: 1280px) 100vw, 1152px" className="object-cover" priority /><div className="absolute inset-0 bg-blue-900/30" /></div></div></section>
