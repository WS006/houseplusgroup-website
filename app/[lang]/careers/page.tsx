      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="relative py-24 px-4 bg-slate-900 text-white overflow-hidden">
          <div className="absolute inset-0 opacity-40">
            <img 
              src="https://images.houseplus-ch.com/media/7d3e4426-84de-441e-b9ce-86b385f4c0ff/"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl">
                <img 
                  src="https://images.houseplus-ch.com/media/d51397fe-cf8d-4660-a3e1-22dc5374710b/"
