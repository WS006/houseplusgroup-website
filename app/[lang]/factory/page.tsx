          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative h-80 rounded-2xl overflow-hidden shadow-2xl">
                <img
                  src="https://houseplus-media-api.jack006hu.workers.dev/media/d3642fb5-d016-4cec-aa3a-e9ab2326050a"
        ...
        <section className="py-12 px-4 bg-slate-50">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {[
                { src: 'https://houseplus-media-api.jack006hu.workers.dev/media/ca450b7a-5f1a-46e9-85b4-ff523b4b1bb8', alt: 'Home appliance production line — precision manufacturing' },
                { src: 'https://houseplus-media-api.jack006hu.workers.dev/media/fa65d41c-2e23-4880-a19f-774c3bacdaa1', alt: 'Solar energy equipment assembly line' },
                { src: 'https://houseplus-media-api.jack006hu.workers.dev/media/951527a9-22ef-4ef3-9dfb-29c78bd9e99e', alt: 'Automated home appliance production equipment' },
              ].map((img) => (
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="relative h-80 rounded-2xl overflow-hidden shadow-xl border border-slate-100">
                <img
                  src="https://houseplus-media-api.jack006hu.workers.dev/media/93c9172f-bc50-400b-b347-4c212f7b2137"
