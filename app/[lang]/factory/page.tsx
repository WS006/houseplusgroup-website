        ...
        <section className="py-12 px-4 bg-slate-50">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {[
                { src: 'https://images.houseplus-ch.com/media/houseplus-factory-production-line/', alt: 'Home appliance production line — precision manufacturing' },
                { src: 'https://images.houseplus-ch.com/media/houseplus-factory-factory-solar-assembly-line/', alt: 'Solar energy equipment assembly line' },
                { src: 'https://images.houseplus-ch.com/media/houseplus-factory-assembly-line/', alt: 'Automated home appliance production equipment' },
              ].map((img) => (
