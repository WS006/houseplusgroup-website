...
const articleContent: Record<string, any> = {
  en: {
    ...
    heroImage: 'https://images.houseplus-ch.com/articles/appliances/smart-kitchen-appliances-modern.jpg',
    heroImageAlt: 'HousePlus smart home appliances lineup for wholesale buyers',
    sections: [
      {
