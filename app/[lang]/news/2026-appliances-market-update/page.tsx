...
const articleContent: Record<string, any> = {
  en: {
    ...
    heroImage: 'https://images.houseplus-ch.com/media/houseplus-articles-covers-2026-appliances-market-update-b2b-guide/',
    ...
    sections: [
      ...
      ,
        image: 'https://images.houseplus-ch.com/media/houseplus-articles-appliances-smart-home-trends-2026-b2b-guide/',
      ...
      ,
        image: 'https://images.houseplus-ch.com/media/houseplus-articles-appliances-smart-refrigerator-2026-b2b-guide/',
      ...
      ,
        image: 'https://images.houseplus-ch.com/media/houseplus-articles-appliances-washing-machine-2026-b2b-guide/',
      ...
      ,
        image: 'https://images.houseplus-ch.com/media/houseplus-articles-appliances-air-conditioner-2026-b2b-guide/',
      ...
      ,
        image: 'https://images.houseplus-ch.com/media/houseplus-articles-appliances-b2b-distribution-2026-b2b-guide/',
