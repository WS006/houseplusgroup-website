...
const articleContent: Record<string, any> = {
  en: {
    ...
    heroImage: 'https://images.houseplus-ch.com/media/houseplus-articles-covers-2026-smart-home-appliances-market-guide-b2b-guide/',
    ...
    sections: [
      ...
      ,
        image: 'https://images.houseplus-ch.com/media/houseplus-smart-wifi-plug-meter-wholesale/',
