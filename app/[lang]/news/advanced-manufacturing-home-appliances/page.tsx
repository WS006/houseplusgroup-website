...
export default async function AdvancedManufacturingArticle(props: { params: Promise<{ lang: string }> }) {
  const params = await props.params;
  const { lang } = params;
  ...
  const articleContent: Record<string, any> = {
    en: {
      ...
      },
      {
        ...
        image: 'https://images.houseplus-ch.com/media/houseplus-articles-service-factory-assembly-workers-b2b-guide/',
