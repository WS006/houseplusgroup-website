...
export default async function NewsPage({ params }: { params: { lang: string } }) {
  ...
  const articles = [
    ...blogArticles,
    {
      ...
      image: 'https://houseplus-media-api.jack006hu.workers.dev/media/1f4dac40-3e4c-4b68-9bb5-b4d596c5f5f4',
    ...
    },
    {
      ...
      image: 'https://houseplus-media-api.jack006hu.workers.dev/media/a01d9b03-6265-4e9e-9500-edb50c289152',
    ...
    },
    {
      ...
      image: 'https://houseplus-media-api.jack006hu.workers.dev/media/ab54c494-e09b-4e89-9b9e-afbd1c932c16',
    ...
    image: 'https://houseplus-media-api.jack006hu.workers.dev/media/58f2d257-8d5c-481d-acd7-edb56c65c5b3',
  ...
  },
  {
    ...
    image: 'https://houseplus-media-api.jack006hu.workers.dev/media/8df3552b-495a-4f26-9292-197f1b592597',
  ...
  },
  {
    ...
    image: 'https://houseplus-media-api.jack006hu.workers.dev/media/56493de4-d16d-4b6e-935a-9daa1bbb5f07',
...

    {
      ...
      image: 'https://houseplus-media-api.jack006hu.workers.dev/media/5ec6c2d5-bed3-4f1d-a04d-2a2a56a8c54f',
    ...
    },
    {
      ...
      image: 'https://houseplus-media-api.jack006hu.workers.dev/media/18406370-f61f-4c38-99d6-b6ba4ca5e659',
    ...
    },
    {
      ...
      image: 'https://houseplus-media-api.jack006hu.workers.dev/media/99546983-391c-4c1d-8843-863643d0bf18',
    ...
    },
    {
      ...
      image: 'https://houseplus-media-api.jack006hu.workers.dev/media/1a43d798-709d-41fa-be2c-b978573f6a49',
    ...
    },
    {
      ...
      image: 'https://houseplus-media-api.jack006hu.workers.dev/media/f0a4515c-e1f7-4037-a943-4d7381c90a34',
    ...
    },
    {
      ...
      image: 'https://houseplus-media-api.jack006hu.workers.dev/media/f58941f1-cba4-4bd3-bb11-b73cf4f63664',
