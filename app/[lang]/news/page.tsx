...
export default async function NewsPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const articles = [
    {
      ...
      image: 'https://images.houseplus-ch.com/articles/electronics/battery-testing-lab-equipment.jpg',
  ...
  },
  {
    ...
    image: 'https://images.houseplus-ch.com/articles/electronics/electronics-headphones-audio.jpg',
...

    {
      ...
      image: 'https://images.houseplus-ch.com/articles/appliances/smart-home-living-room.jpg',
