...
export default async function SmartHomeAppliancesArticle({ params }: { params: { lang: string } }) {
  ...
  const articleContent: Record<string, any> = {
    en: {
      ...
      image: 'https://images.houseplus-ch.com/media/c41b8c7f-f034-49c3-93d4-b4499b6b2dcd/',
      ...
      sections: [
        ...
        },
        {
          ...
          image: 'https://images.houseplus-ch.com/media/7c1147cf-92c3-45b1-b683-1e7070703c89/',
