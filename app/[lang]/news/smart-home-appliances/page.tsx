...
export default async function SmartHomeAppliancesArticle({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const articleContent: Record<string, any> = {
    en: {
      ...
      image: 'https://images.houseplus-ch.com/images/products/kitchen-appliances.jpg',
      ...
      sections: [
        {
          ...
          image: 'https://images.houseplus-ch.com/images/products/appliances-showcase.jpg',
        ...
        },
        {
          ...
          image: 'https://images.houseplus-ch.com/images/products/appliances-package.jpg',
        ...
        },
        {
          ...
          image: 'https://images.houseplus-ch.com/images/products/wireless-charger.jpg',
