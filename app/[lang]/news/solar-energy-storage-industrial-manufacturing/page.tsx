...
const articleContent: Record<string, any> = {
  en: {
    ...
    heroImage: 'https://images.houseplus-ch.com/media/houseplus-articles-covers-solar-energy-storage-industrial-manufacturing-b2b-guide/',
