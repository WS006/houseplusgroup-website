...
export default async function SolarEnergyStorageArticle({ params }: { params: { lang: string } }) {
  ...
  const articleContent: Record<string, any> = {
    en: {
      ...
      image: 'https://images.houseplus-ch.com/media/a70ffc8f-c63c-45bc-949e-6ff11431097d/',
      ...
      sections: [
        {
          ...
          image: 'https://images.houseplus-ch.com/media/e0245a6c-9df0-40ed-997e-d29c73309ac3/',
        ...
        },
        {
          ...
          image: 'https://images.houseplus-ch.com/media/8f7da832-0947-4d91-ab42-fb64fce87b8d/',
