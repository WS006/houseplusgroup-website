...
const articleContent: Record<string, any> = {
  en: {
    ...
    heroImage: 'https://images.houseplus-ch.com/media/houseplus-articles-covers-solar-storage-efficiency-optimization-guide-b2b-guide/',
    ...
    sections: [
      ...
      ,
        image: 'https://images.houseplus-ch.com/media/houseplus-charge-controller-60a-wholesale/',
...
export default async function BlogPostPage({ params }: { params: { lang: string } }) {
  ...
  const imageObjectSchema = generateImageObjectSchema({
    ...
    description: 'Industrial solar energy storage system efficiency analysis with battery bank, inverter, and real-time performance metrics',
    width: 1200,
    height: 675,
  });
