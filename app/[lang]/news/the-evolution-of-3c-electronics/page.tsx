...
export default async function ThreeCElectronicsArticle({ params }: { params: { lang: string } }) {
  const { lang } = params;
  ...
  const articleContent: Record<string, any> = {
    en: {
      ...
      image: 'https://houseplus-media-api.jack006hu.workers.dev/media/b27365bb-fd56-47d0-9e87-437f365e60b0',
          ...
          sections: [
      {
        ...
        image: 'https://houseplus-media-api.jack006hu.workers.dev/media/7e48bd2c-3570-4527-9af3-78b81731e16d',
      ...
      },
      {
        ...
        image: 'https://houseplus-media-api.jack006hu.workers.dev/media/8d271900-f7f0-4415-82fe-e0fdaa9875c6',
    ...
    fr: {
                  ...
                  sections: [
      {
        ...
        image: 'https://houseplus-media-api.jack006hu.workers.dev/media/1387f02c-fe72-466e-b383-bfe4f27a716b',
      ...
      },
      {
        ...
        image: 'https://houseplus-media-api.jack006hu.workers.dev/media/735c5115-bf87-4cf8-bbc8-5b5e6472e290',
      ...
      },
      {
        ...
        image: 'https://houseplus-media-api.jack006hu.workers.dev/media/951527a9-22ef-4ef3-9dfb-29c78bd9e99e',
