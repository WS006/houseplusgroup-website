...
export default async function SolarEnergyArticle({ params }: { params: { lang: string } }) {
  const { lang } = params;
  ...
  const articleContent: Record<string, any> = {
    en: {
      ...
      image: 'https://houseplus-media-api.jack006hu.workers.dev/media/9c25f9ff-fae9-4d82-8263-8f9a41f4239d',
      ...
      sections: [
        ...
        },
        {
          ...
          image: 'https://houseplus-media-api.jack006hu.workers.dev/media/ecf442ab-f6c0-405c-b6f8-f84ad418e606',
