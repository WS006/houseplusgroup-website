...
export default async function SolarEnergyArticle(props: { params: Promise<{ lang: string }> }) {
  const params = await props.params;
  const { lang } = params;
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          image: 'https://images.houseplus-ch.com/media/houseplus-articles-solar-solar-panel-installation-rooftop-b2b-guide/',
