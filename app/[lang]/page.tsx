...
export default async function LangHome({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const defaultCarouselItems = dict.home.carousel.map((item, index) => ({
    _uid: String(index + 1),
    image: {
      filename: `https://images.houseplus-ch.com/products/${['solar-panel-500w.jpg', 'air-fryer-5-8l.jpg', 'headphone-over-ear.jpg'][index]}`,
      alt: item.imageAlt
    },
    title: item.title,
        ...
        <div className="space-y-0">
          {dict.home.industries.map((industry, index) => (
            <IndustrySection
              ...
              image={{ filename: `https://images.houseplus-ch.com/products/${['solar-panel-500w.jpg', 'air-fryer-5-8l.jpg', 'headphone-over-ear.jpg'][index]}`, alt: industry.title }}
