...
const products = [
  // ── Solar Energy Systems ──────────────────────────────────────────────────
  {
    ...
    category: 'solar',
    model: 'HP-SP500',
    coverImage: '/images/products/solar-panel-500w.jpg',
  ...
  },
  {
    ...
    category: 'solar',
    model: 'HP-INV3000',
    coverImage: '/images/products/solar-inverter-3kw.jpg',
  ...
  },
  {
    ...
    category: 'solar',
    model: 'HP-LFP5K',
    coverImage: '/images/products/lithium-battery-5kwh.jpg',
  ...
  },
  {
    ...
    category: 'solar',
    model: 'HP-LA100',
    coverImage: '/images/products/lead-acid-battery-100ah.jpg',
  ...
  },
  {
    ...
    category: 'solar',
    model: 'HP-MPPT60',
    coverImage: '/images/products/charge-controller-60a.jpg',
  ...
  },
  {
    ...
    category: 'solar',
    model: 'HP-SSL200',
    coverImage: '/images/products/solar-street-light-200w.jpg',
  ...
  },
  {
    ...
    category: 'solar',
    model: 'HP-SF20',
    coverImage: '/images/products/solar-fan-20w.jpg',
  ...
  },
  {
    ...
    category: 'solar',
    model: 'HP-SPB20K',
    coverImage: '/images/products/solar-power-bank-20000mah.jpg',
  ...
  // ── Home Appliances ───────────────────────────────────────────────────────
  {
    ...
    category: 'appliances',
    model: 'HP-AF58',
    coverImage: '/images/products/air-fryer-5-8l.jpg',
  ...
  },
  {
    ...
    category: 'appliances',
    model: 'HP-IC2000',
    coverImage: '/images/products/induction-cooktop-2000w.jpg',
  ...
  },
  {
    ...
    category: 'appliances',
    model: 'HP-EK15',
    coverImage: '/images/products/electric-kettle-1-5l.jpg',
  ...
  },
  {
    ...
    category: 'appliances',
    model: 'HP-TS2',
    coverImage: '/images/products/toaster-2-slice.jpg',
  ...
  // ── 3C Electronics ────────────────────────────────────────────────────────
  {
    ...
    model: 'HP-HE01',
    coverImage: '/images/products/headphone-over-ear.jpg',
  ...
  },
  {
    ...
    category: 'electronics',
    model: 'HP-TWS01',
    coverImage: '/images/products/bluetooth-earphone-tws.jpg',
  ...
  },
  {
    ...
    category: 'electronics',
    model: 'HP-SW01',
    coverImage: '/images/products/smart-watch.jpg',
  ...
  },
  {
    ...
    category: 'electronics',
    model: 'HP-SSD1T',
    coverImage: '/images/products/portable-ssd-1tb.jpg',
  ...
  },
  {
    ...
    category: 'electronics',
    model: 'HP-SD128',
    coverImage: '/images/products/micro-sd-128gb.jpg',
  ...
  },
  {
    ...
    category: 'electronics',
    model: 'HP-CC2M',
    coverImage: '/images/products/usb-c-cable-2m.jpg',
