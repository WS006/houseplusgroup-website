          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="relative h-72 rounded-2xl overflow-hidden shadow-lg">
                <img
                  src="https://houseplus-media-api.jack006hu.workers.dev/media/2946709f-9053-4d33-991a-28e37dfd3f27"
              ...
              <div className="relative h-72 rounded-2xl overflow-hidden shadow-lg">
                <img
                  src="https://houseplus-media-api.jack006hu.workers.dev/media/93e131d6-97cb-4ef4-a371-909061a46afc"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="relative h-80 rounded-2xl overflow-hidden shadow-xl border border-slate-100">
                <img
                  src="https://houseplus-media-api.jack006hu.workers.dev/media/886e83cd-9f61-4f90-a1e7-5d8e2c290394"
