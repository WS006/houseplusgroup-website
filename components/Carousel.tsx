...
export default function Carousel({ items, autoPlayInterval = 5000, lang = 'en' }: CarouselProps) {
  ...
  const getDefaultItems = (): CarouselItem[] => [
    {
      _uid: 'default-1',
      image: { filename: '/images/home/solar-hero.jpg', alt: 'HousePlus Solar Energy Solutions — Solar Panels and Power Stations for Wholesale' },
    ...
    {
      _uid: 'default-2',
      image: { filename: '/images/home/appliances-hero.jpg', alt: 'HousePlus Smart Home Appliances — Air Fryers, Kettles and Kitchen Appliances OEM ODM' },
    ...
    {
      _uid: 'default-3',
      image: { filename: '/images/home/electronics-hero.jpg', alt: 'HousePlus 3C Electronics — Headphones, Smart Watches, SSD and Charging Accessories Wholesale' },
