...
const footerContent: Record<string, FooterContent> = {
  en: {
    ...
    contact: [
      ...
      { label: 'WhatsApp', value: '+8615578119543', href: 'https://wa.me/8615578119543' },
      { label: 'Phone', value: '+2349078080738' },
  ...
  es: {
    ...
    contact: [
      ...
      { label: 'WhatsApp', value: '+8615578119543', href: 'https://wa.me/8615578119543' },
      { label: 'Teléfono', value: '+2349078080738' },
      { label: 'WeChat', value: 'JackHousePlus' },
    ],
  ...
  de: {
    ...
    contact: [
      ...
      { label: 'WhatsApp', value: '+8615578119543', href: 'https://wa.me/8615578119543' },
      { label: 'Telefon', value: '+2349078080738' },
      { label: 'WeChat', value: 'JackHousePlus' },
    ],
  ...
  fr: {
    ...
    contact: [
      { label: 'Email', value: 'jack@houseplus-ch.com', href: 'mailto:jack@houseplus-ch.com' },
      { label: 'WhatsApp', value: '+8615578119543', href: 'https://wa.me/8615578119543' },
      { label: 'Téléphone', value: '+2349078080738' },
      { label: 'WeChat', value: 'JackHousePlus' },
    ],
  ...
  ar: {
    ...
    contact: [
      ...
      { label: 'واتس آب', value: '+8615578119543', href: 'https://wa.me/8615578119543' },
      { label: 'الهاتف', value: '+2349078080738' },
