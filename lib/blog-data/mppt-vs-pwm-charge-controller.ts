  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'For large systems above 1 kilowatt, off-grid cabins, and RV or marine applications with high-voltage panel arrays, MPPT is often the appropriate option. The ability to wire panels in series for higher voltage can reduce wire losses and allow smaller gauge cabling, which is especially valuable in RV and marine installations where space and weight are constrained. For a HousePlus controller inquiry, confirm the applicable model, electrical specifications and destination-specific compliance documentation before purchase.',
      ],
    },
    {
