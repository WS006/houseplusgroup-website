...
const article: BlogPost = {
  ...
  heroImage:
    'https://houseplus-media-api.jack006hu.workers.dev/media/328d6bbc-d1b1-487c-9604-eb7a66ba3d93',
  heroImageAlt:
  ...
  productRecommendations: [
    {
      ...
      image:
        'https://houseplus-media-api.jack006hu.workers.dev/media/6a0caf8d-e8ef-4ee9-86ed-20c082f9a091',
    },
    {
      ...
      image:
        'https://houseplus-media-api.jack006hu.workers.dev/media/7029a48a-1aed-4de9-9545-e4ebe710a7e5',
    },
    {
