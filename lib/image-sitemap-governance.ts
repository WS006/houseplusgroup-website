...
export const CURATED_CORE_PAGE_IMAGES: CuratedCorePageImage[] = [
  { pageUrl: '/en', role: IMAGE_SITEMAP_RELATION_ROLES.pageHero, loc: 'https://images.houseplus-ch.com/media/houseplus-solar-panel-500w-wholesale/', title: 'HousePlus solar energy solutions', caption: 'Solar panels, inverters and energy storage solutions for global wholesale buyers.' },
  { pageUrl: '/en', role: IMAGE_SITEMAP_RELATION_ROLES.pageHero, loc: 'https://images.houseplus-ch.com/media/houseplus-air-fryer-5-8l-wholesale/', title: 'HousePlus home appliances', caption: 'Home appliances for retail selection and B2B sourcing discussions.' },
  { pageUrl: '/en', role: IMAGE_SITEMAP_RELATION_ROLES.pageHero, loc: 'https://images.houseplus-ch.com/media/houseplus-headphone-over-ear-wholesale/', title: 'HousePlus 3C electronics', caption: '3C electronics and accessories for international B2B distribution.' },
